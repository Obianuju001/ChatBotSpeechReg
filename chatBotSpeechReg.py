...
st.markdown("<h6 style = 'text-align: center; top-margin: 0rem; color: #64CCC5'>BUILT BY OBIANUJU ONYEKWELU</h1>", unsafe_allow_html = True)

st.markdown("<br> <br>", unsafe_allow_html= True)
col1, col2 = st.columns(2)
col1.image('SpeechChat_Image.jpg', width = 300, caption = 'Mental Health Related Chats')
